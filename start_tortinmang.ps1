# ============================================================
# TORTINMANG.UZ — Watchdog (24/7 avtomatik qayta ishga tushiruvchi)
# Foydalanish: powershell -ExecutionPolicy Bypass -File start_tortinmang.ps1
# ============================================================

$BOT_DIR       = Split-Path -Parent $MyInvocation.MyCommand.Path
$SCRIPT        = Join-Path $BOT_DIR "run_v2.py"
...
Write-Host "   TORTINMANG.UZ - 24/7 Watchdog" -ForegroundColor Yellow
...
Log "=== TORTINMANG.UZ Watchdog ishga tushdi ==="
