@echo off
title TORTINMANG.UZ — Auto-Login Sozlash
color 0A

echo ============================================================
echo   TORTINMANG.UZ — Auto-Login va Autostart O'rnatuvchi
echo ============================================================
echo.
...
schtasks /Create /TN "TORTINMANG_Bot" /TR "powershell.exe -WindowStyle Hidden -ExecutionPolicy Bypass -File \"%~dp0start_tortinmang.ps1\"" /SC ONSTART /RU SYSTEM /RL HIGHEST /F
if %errorLevel% EQU 0 (
...
schtasks /Query /TN "TORTINMANG_Bot" /FO LIST 2>nul | findstr "Task Name\|Status\|Run As User"
...
echo   3. TORTINMANG.UZ bot avtomatik ishga tushadi
