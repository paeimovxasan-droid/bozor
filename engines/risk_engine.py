"""
TORTINMANG.UZ — Dynamic Risk Engine
...
class DynamicRiskEngine:
    ...
    def calculate_lot(
        ...
        # MT5 ulanmagan yoki symbol topilmagan bo'lsa symbol_info=None bo'lishi
        # mumkin — bo'sh dict bilan himoyalanamiz (AttributeError oldini oladi).
